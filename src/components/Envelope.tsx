        ...
        >
          <div className="relative w-full max-w-sm h-64 mx-4 perspective-1000">
             ...
             >
                ...
                >
                   <p className="font-script text-3xl md:text-2xl text-primary mb-6">We are getting married!</p>
                   <h1 className="font-serif text-1xl md:text-2xl tracking-widest text-text mb-4">Nele <span className="text-accent">&</span> Luis</h1>
                ...
                <motion.div
                 ...
                 >
                    ...
                    <div className="absolute -top-[100px] w-20 h-20 rounded-full bg-[#c24d2c] shadow-lg flex items-center justify-center border-4 border-[#b6cdbd]/30">
                       <span className="font-script text-white text-3xl pt-1">N&L</span>
                    </div>
                 </motion.div>
             </motion.div>
          </div>
